...
public class ComicReadGalleryAdapter extends BaseAdapter {
	...
	public ComicReadGalleryAdapter(Activity activity,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		LayoutParams lp = (LayoutParams) holder.comic_read_item_image
				.getLayoutParams();
		int dWidth = BaseTools.getwidthPixels(activity);
		lp.width = (int) (dWidth);
		holder.comic_read_item_image.setLayoutParams(lp);
